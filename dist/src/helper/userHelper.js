...
exports.resetPassword = exports.getAllUsersForHostel = exports.getUserProfileHelper = exports.verifyAndcreateHostelUser = exports.updateUser = exports.deleteUser = exports.getUserByEmail = exports.getUserById = exports.getUsers = exports.createUser = void 0;
...
function mapUserWithHostel(user) {
    var _a, _b, _c, _d, _e, _f;
    const hostel = (_f = (_d = (_b = (_a = user.adminProfile) === null || _a === void 0 ? void 0 : _a.hostel) !== null && _b !== void 0 ? _b : (_c = user.staffProfile) === null || _c === void 0 ? void 0 : _c.hostel) !== null && _d !== void 0 ? _d : (_e = user.residentProfile) === null || _e === void 0 ? void 0 : _e.hostel) !== null && _f !== void 0 ? _f : null;
    const { adminProfile, staffProfile, residentProfile } = user, rest = __rest(user, ["adminProfile", "staffProfile", "residentProfile"]);
    return Object.assign(Object.assign({}, rest), { hostel });
}
...
function buildUserUpdateData(userData, picture) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (userData.accountStatus !== undefined)
            data.accountStatus = userData.accountStatus;
...
const createUser = (userData, picture) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const resolvedFirstName = (_a = userData.firstName) !== null && _a !== void 0 ? _a : derivedNames.firstName;
        const resolvedLastName = (_b = userData.lastName) !== null && _b !== void 0 ? _b : derivedNames.lastName;
        const normalizedPhone = (_d = (_c = userData.phone) !== null && _c !== void 0 ? _c : userData.phoneNumber) !== null && _d !== void 0 ? _d : null;
        ...
        const userRecord = {
            ...
            role: (_e = userData.role) !== null && _e !== void 0 ? _e : client_1.Role.admin,
            gender: (_f = userData.gender) !== null && _f !== void 0 ? _f : null,
            phone: normalizedPhone,
        };
        if (avatar) {
            userRecord.avatar = avatar;
        }
        const resolvedImageUrl = (_h = (_g = picture === null || picture === void 0 ? void 0 : picture.imageUrl) !== null && _g !== void 0 ? _g : userData.imageUrl) !== null && _h !== void 0 ? _h : undefined;
        if (resolvedImageUrl) {
            userRecord.imageUrl = resolvedImageUrl;
        }
        const resolvedImageKey = (_k = (_j = picture === null || picture === void 0 ? void 0 : picture.imageKey) !== null && _j !== void 0 ? _j : userData.imageKey) !== null && _k !== void 0 ? _k : undefined;
        if (resolvedImageKey) {
