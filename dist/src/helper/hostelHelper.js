...
exports.unPublishHostel = exports.publishHostel = exports.getUnverifiedHostel = exports.updateHostel = exports.deleteHostel = exports.getHostelById = exports.getAllHostels = exports.addHostel = void 0;
...
const addHostel = (hostelData, pictures, logoInfo) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const createdHostel = yield prisma_1.default.hostel.create({
            data: Object.assign(Object.assign({}, hostelData), { logoUrl: logoInfo === null || logoInfo === void 0 ? void 0 : logoInfo.logoUrl, logoKey: logoInfo === null || logoInfo === void 0 ? void 0 : logoInfo.logoKey }),
        });
        if (!createdHostel) {
...
const updateHostel = (hostelId, hostelData, pictures, logoInfo) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedHostel = yield prisma_1.default.hostel.update({
            where: { id: hostelId },
            data: hostelData,
        });
