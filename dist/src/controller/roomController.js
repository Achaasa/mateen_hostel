...
const updateRoomControllerAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { roomId } = req.params; // Room ID from the URL parameters
    const _a = req.body, { addAmenitiesIds, removeAmenitiesIds } = _a, filteredBody = __rest(_a, ["addAmenitiesIds", "removeAmenitiesIds"]);
    const roomData = Object.assign(Object.assign({}, filteredBody), { price: req.body.price ? parseFloat(req.body.price) : undefined, maxCap: req.body.maxCap ? parseInt(req.body.maxCap) : undefined });
    const photos = req.files;
