...
// User sign up
userRouter.post("/signup", multer_1.default.single("photo"), jsonwebtoken_1.authenticateJWT, (0, jsonwebtoken_1.authorizeRole)(["super_admin", "admin"]), (0, validate_payload_1.validatePayload)("User"), // Assuming you have validation logic for user payload
...
// Get user by ID
userRouter.get("/get/:userId", jsonwebtoken_1.authenticateJWT, (0, jsonwebtoken_1.authorizeRole)(["super_admin", "admin"]), AccessControl_1.validateHostelAccess, userController_1.getUserById);
// Update user
...
// User login
userRouter.post("/login", (0, validate_payload_1.validatePayload)("User"), userController_1.userLogIn);
// Get user profile
