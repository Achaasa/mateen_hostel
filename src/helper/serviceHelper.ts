...
export const createHostelService = async (
    ...
    try {
        ...
        // Also check staff if they are allowed, but usually only Admin creates services
        // Or check if user is super_admin (but they might not have hostelId directly without profile)
        // We stick to AdminProfile for "Hostel Admin"
